...
<head>
    ...
    <title>Aquabase – @yield('title', 'Dashboard')</title>
...
<nav class="fb-navbar">
    ...
    <div class="right-section">
        <div class="user-info">
            ...
            <div class="user-name">
                {{ session('first_name', '') }} {{ session('last_name', 'Admin') }}
            </div>
        </div>
...
<aside class="fb-sidebar" id="sidebar">
    ...
    <a href="{{ route('admin.suppliers.index') }}" class="sidebar-item {{ request()->routeIs('admin.suppliers.*') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.staffs.index') }}" class="sidebar-item {{ request()->routeIs('admin.staffs.*') ? 'active' : '' }}">
...
<main class="fb-main" id="fbMain">
    ...
    <div class="hero-text">
        ...
        <span class="hero-text-mobile">
            @yield('hero-text-mobile', '👋 Hey ' . session('first_name', 'Admin') . ', manage Claudio\'s Aquafarm')
        </span>
    </div>
</div>
...
<script>
    ...
    const STORE_KEY   = 'aq_admin_sidebar_open';
