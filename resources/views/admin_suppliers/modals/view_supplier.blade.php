...
<div class="fb-modal-backdrop" id="viewSupplierModal">
    <div class="fb-modal" style="max-width: 440px;">
        ...
        <div class="modal-body-wrap">
            <div class="modal-title" id="viewSupNameTitle">Supplier Details</div>

            <div class="view-detail-grid">
                <div class="view-detail-item">
                    <span class="detail-label">ID</span>
                    <span class="detail-value" id="viewSupId" style="color: var(--blue-mid);"></span>
                </div>
                <div class="view-detail-item">
                    <span class="detail-label">Supplier Name</span>
                    <span class="detail-value" id="viewSupName"></span>
                </div>
                <div class="view-detail-item">
                ...
                <div class="view-detail-item">
                    ...
                    <span class="detail-value" id="viewSupEmail"></span>
                </div>
                <div class="view-detail-item" style="grid-column: 1 / -1;">
                    <span class="detail-label">Address</span>
                    <span class="detail-value" id="viewSupAddress"></span>
                </div>
                <div class="view-detail-item" style="grid-column: 1 / -1;">
                    <span class="detail-label">Description</span>
                    <span class="detail-value" id="viewSupDescription"></span>
                </div>
                <div class="view-detail-item" style="grid-column: 1 / -1;">
        ...
        <div class="modal-footer-btns">
            <button class="btn-modal-back" onclick="closeModal('viewSupplierModal')">Close</button>
        </div>
    </div>
</div>