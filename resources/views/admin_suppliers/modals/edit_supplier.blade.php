...
<div class="fb-modal-backdrop" id="editSupplierModal">
    <div class="fb-modal">
        ...
        <div class="modal-body-wrap">
            ...
            <form method="POST" class="modal-form" id="editSupplierForm">
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label class="form-label">Supplier Name <span style="color:#c0392b">*</span></label>
                    <input type="text" name="supplier_name" id="editSupName" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Contact Number</label>
                    <input type="text" name="contact_no" id="editSupContact" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" id="editSupAddress" class="form-control" rows="2"></textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea name="description" id="editSupDescription" class="form-control" rows="2"></textarea>
                </div>
            </form>
        </div>

        <div class="modal-footer-btns">
            <button class="btn-modal-back" onclick="closeModal('editSupplierModal')">Cancel</button>
            <button class="btn-modal-submit" onclick="document.getElementById('editSupplierForm').submit()">Update Supplier</button>
        </div>
    </div>
</div>