...
@push('styles')
<style>
    /* Modal base styles – ensures modal is hidden by default */
    .fb-modal-backdrop {
        display: none;
        position: fixed;
        inset: 0;
...
<div class="fb-modal-backdrop" id="addSupplyModal">
    <div class="fb-modal">
        ...
        <div class="modal-body-wrap">
            ...
            <form action="{{ route('admin.inventory.store') }}" method="POST" enctype="multipart/form-data" class="modal-form" id="addSupplyForm">
                @csrf
                <div class="mb-3">
        ...
        <div class="modal-footer-btns">
            <button class="btn-modal-back" onclick="closeModal('addSupplyModal')">Cancel</button>
            <button class="btn-modal-submit" onclick="document.getElementById('addSupplyForm').submit()">Add Supply</button>
        </div>
    </div>
</div>